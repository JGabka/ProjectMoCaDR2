...
def experiment_grid(k_values, w_values, alpha_values, n_repeats=10):
    results = []
...
if __name__ == "__main__":
    ...
    print("Plotting TVD vs w...")
    plot_tvd_vs_w(results, alpha_fixed=0.5)

    print("Plotting TVD vs alpha...")
    plot_tvd_vs_alpha(results)
